...
export default function ListViewCard({city, name, picture, email, cell}) {  
          ...
          const ListViewCardRandomBg=(bgArr[randomBg]);
          
          return (
                <div id={ListViewCardRandomBg} className='fade-in ListViewCardBg'>
                        <div className='user-image-container-list-view'> 
                            <img className='user-image-list-view' src={picture} alt={name} />
                        </div>  
                        <div id='name-address'>
                            <h4>{name}</h4>
                            <h6>{city}</h6>
                        </div> 
                        <div className='email-cell-icons' id='icons-container-list-view'>
